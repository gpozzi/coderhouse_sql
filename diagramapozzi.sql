/* Script de creación de tablas en SQL para el curso de SQL en Coderhouse (dic 2021 - abr 2022) - Primera entrega 01/02/22 */

CREATE DATABASE IF NOT EXISTS diagramaPozzi;
USE diagramapozzi;

/* Tabla de dimensión que contiene datos sobre proveedores */
...
/* Tabla de dimensión que contiene datos sobre clientes */
...
/* Tabla de dimensión que contiene información sobre las categorías de productos (nombres de categorías en 3 niveles,/* 
...
/* Tabla de dimensión que contiene información sobre cada producto en el inventario */
...
/* Tabla de hechos que contiene información sobre cada pedido realizado en el ERP */
